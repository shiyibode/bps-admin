Ext.define('MyApp.locale.zh_CN',{
    override: 'MyApp.locale.Locale',
    ...
    statics: {
        ...
        AppTitle: 'MyApp后台管理系统',
        DefaultMessageTitle: '信息',
        GetUserInfo: '正在加载用户信息......',
        GetMenuInfo: '正在加载菜单信息......',
        GetOrganizationInfo: '正在加载机构信息......',
        GetRoleInfo: '正在加载角色信息......',
        ...
        UserAnotherAccountToLogin: '使用其他账户登录',
        ResumeWarning: '连接超时，请重新输入密码登录',
        UpdateUserPassword: '修改密码',
        OriginalPassword: '原密码',
        NewPassword: '新密码',
        ConfirmPassword: '确认新密码',
        MinLengthRequirement: '密码最小长度为6位',
        NewPasswordNotSame: '2次输入的新密码不一致',
        OriginalPasswordSameAsNewPassword: '新旧密码相同，无需修改',
        RoleApiWindow: '编辑角色接口'
    }
})