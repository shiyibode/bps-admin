...
Ext.define('MyApp.view.cktj.DepositEmpAvgPayment',{
    extend: 'Ext.panel.Panel',
    xtype: 'cktjdepositempavgpayment',
    ...
    initComponent: function() {
        ...
        dataStore = viewModel.getStore('employeeAvgDepositPaymentStore');
        ...
        me.items.push({
            ...
            bind: {
                ...
                store: '{employeeAvgDepositPaymentStore}'
            },
            moduleId: 'empavgpayment',
            matrix: myMatrix
        });
