...
Ext.define('MyApp.view.cktj.DepositEmployeePayment',{
    extend: 'Ext.panel.Panel',
    xtype: 'cktjdepositemployeepayment',
    ...
    initComponent: function() {
        ...
        var dataStore = null;
        var myMatrix = null;
        dataStore = viewModel.getStore('employeeDepositPaymentStore');
        ...
        me.items.push({
            ...
            moduleId: 'employeepayment',
            bind: {
                store: '{employeeDepositPaymentStore}'
            },
            matrix: myMatrix
        });
